...
export type AdminNavItem = {
  ...
  /**
   * PHP admin path — opens in new tab until React migration (Phase 5–6).
   * e.g. `/admin/sites/` stays on legacy PHP admin.
   */
  externalHref?: string;
...
export const SIDEBAR_NAV: AdminNavItem[] = [
  ...
  { id: 'sites', label: '사이트', icon: Globe, externalHref: '/admin/sites/', adminOnly: true },
  { id: 'products', label: '상품', icon: Package, externalHref: '/admin/products/', adminOnly: true },
...
export const MORE_NAV: AdminNavItem[] = [
  { id: 'sites', label: '사이트관리', icon: Globe, externalHref: '/admin/sites/', adminOnly: true },
